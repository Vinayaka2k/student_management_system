...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="facsingnin.php" method="POST">
    ...
    <div class="container">
      <label for="facid"><b>FACULTY ID</b></label>
      <input type="text" placeholder="Enter FACULTY ID" name="facid" required>

      <label for="cfacid"><b>CONFIRM FACULTY ID</b></label>
      <input type="password" placeholder="CONFIRM FACULTY ID" name="cfacid" required>
